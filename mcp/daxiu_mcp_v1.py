"""
StrokeNet MCP Server - FastMCP 1.x 版本
适用于: FastMCP 1.0.0 - 1.4.x
安装: pip install fastmcp==1.4.0

特点: 支持 HTTP/SSE transport，可以指定 host 和 port
"""
...
if __name__ == "__main__":
    # FastMCP 1.x 语法: run() 方法接受 transport, host, port 参数
